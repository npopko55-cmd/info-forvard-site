...
> нарушение 152-ФЗ. После переезда на reg.ru форма переведена на `send.php` (РФ-сервер).
> Актуальная инструкция: [forma-send-php.md](forma-send-php.md). Файл оставлен для истории.
