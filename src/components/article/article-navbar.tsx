...
/** Шапка страниц статей: ведёт обратно на основной сайт. */
export function ArticleNavbar() {
  ...
  const items = [
    { label: "Услуги", href: `${home}#services` },
    { label: "Аудиторы", href: `${home}#team` },
    { label: "Статьи", href: withBase("/articles/") },
  ];
  ...
  return (
    <header
      className={cn(
        ...
        scrolled ? "glass glass-border shadow-sm py-3" : "bg-white py-5"
      )}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        <a href={home} className="flex items-center gap-2" aria-label="ИНФО ФОРВАРД">
          <Img
      ...
      {mobileOpen && (
        <div className="md:hidden glass glass-border mt-2 mx-4 rounded-2xl p-4 space-y-3">
          ...
          <a href="tel:+79011841190" className="block py-2 text-sm font-medium text-primary">
            +7 (901) 184-11-90
          </a>
          <a
            href={`${home}#contact`}
