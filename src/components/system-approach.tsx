...
const features = [
  ...
  {
    icon: ClipboardCheck,
    title: "Содержательный итоговый отчёт",
    description:
  ...
  {
    icon: Globe,
    title: "РСБУ и работа с консолидацией",
    description:
      "Аудит отчётности по РСБУ. Опыт с консолидированной отчётностью групп компаний и компаниями с иностранным участием.",
  },
];
